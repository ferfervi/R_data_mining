...
![alt text](https://github.com/ferfervi/R_data_mining/blob/master/map_plot_streaming_api_forcadelltv3_europe.jpg  "mapplot_europe")

##### Word cloud of words most used using sreaming API in program ".CAT" of TV3 (Catalan TV 2015-10-29).  
![alt text](https://github.com/ferfervi/R_data_mining/blob/master/wordcloud_streaming_api_forcadelltv3.jpeg  "wordcloud")
